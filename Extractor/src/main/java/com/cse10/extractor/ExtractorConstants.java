...
public class ExtractorConstants {
    ...
    public static final String CRIME_TYPE_ILLEGAL_TRADE = "illegal_trade";
    public static final String CRIME_TYPE_TERRORIST = "terrorist";
    public static final String CRIME_TYPE_OTHER = "other";
    /***********************************************************/
    ...
    public static final String DISTRICT_MONERAGALA = "Moneragala";
    public static final String DISTRICT_MULLAITIVU = "Mullaitivu";
    public static final String DISTRICT_NUWARA_ELIYA = "Nuwara Eliya";
